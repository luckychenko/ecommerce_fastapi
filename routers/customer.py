...
def create_customer(payload: CustomerCreate = Depends(customer_service.check_unique_username)):
...
# @customer_router.put('/edit/{customer_id}', status_code=200)
# def edit_customer(customer_id: int, payload: CustomerCreate, username: str = Depends(customer_service.check_unique_username)):
#     curr_customer = None
#     for customer in customers:
#         if customer.id == customer_id:
#             curr_customer = customer
